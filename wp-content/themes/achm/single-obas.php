  ...
  <main>
    ...
    <section class="pt-95 pb-45 course-area">
          ...
          <div class="col-md-9">
            ...
            <div class="course-top-overview">
              <div class="d-flex overviews">
                <div class="author">
                	 <?php 
                $id_image = get_field('lecturer_profile');
            ...
            <div id="accordion" class="myaccordion mb-50">
              <div class="card">
				...
				?>
              <div class="card">
                <div class="card-header" id="<?php echo get_sub_field('collapse');?>">
                  <h4 class="mb-0">
                ...
                <div id="<?php echo get_sub_field('data-target');?>" class="collapse" aria-labelledby="<?php echo get_sub_field('collapse');?>" data-parent="#accordion">
      ...
      <?php endif;?>
          ...
          <div class="col-md-3">
            <?php if(is_active_sidebar('oba_sidebar') ):?>
                <?php dynamic_sidebar('oba_sidebar');?>
              <?php endif;?>
          </div>
        </div>
      </div>
