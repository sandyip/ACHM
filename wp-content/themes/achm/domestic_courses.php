<?php get_header();
/*Template Name: Domestic Courses*/
?>
<!-- main-area -->
  <main>
    <!-- breadcrumb-area -->
        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 col-lg-9">
            <div class="section-title text-center mb-70">
              <h2><?php the_field('domestic_course_title');?></h2>
              <p><?php the_field('domestic_course_subtitle');?></p>
            </div>
          </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="top-courses-item top-courses-two event-item-wrap mb-50">
              ...
              <div class="top-courses-content">
                <div class="event-top-wrap">
                  <ul>
                    <li class="event-tag"><a href="#">Domestic</a></li>
                  </ul>
                </div>
